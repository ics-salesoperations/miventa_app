...
class ProcessingVentaReasignacion extends StatefulWidget {
  final Planning pdv;

  const ProcessingVentaReasignacion({
    Key? key,
    required this.pdv,
  }) : super(key: key);

  @override
  State<ProcessingVentaReasignacion> createState() =>
      _ProcessingVentaReasignacionState();
}

class _ProcessingVentaReasignacionState
    extends State<ProcessingVentaReasignacion> {
